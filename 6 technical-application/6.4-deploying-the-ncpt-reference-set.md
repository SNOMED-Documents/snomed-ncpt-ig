# 6.4 Deploying the NCPT Reference Set

# Introduction

Effective use of the content of the Reference Set requires access to the content in ways that leverage the features of the terminology. A [terminology service](https://confluence.ihtsdotools.org/display/DOCGLOSS/terminology+service "Glossary link: terminology service") is a software function that interfaces with and provides access to information from one or more representations of a terminology.
...
<figure><img src="../images/259855716.png" alt="" title=""></figure>
...
[code] 
    ^ 1303957004 |NCPT (Nutrition Care Process Terminology) reference set| {{C active=1}}
[/code]
