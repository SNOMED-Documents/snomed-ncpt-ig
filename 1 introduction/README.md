...
* **Information Model and Terminology Binding** - This chapter introduces a generic logical model for nutrition care records, and general terminology bindings, so that healthcare organizations can ensure data are recorded with precision and utilized effectively.
